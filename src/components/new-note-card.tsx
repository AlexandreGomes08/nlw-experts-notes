...
export function NewNoteCard() {
    ...
    /*função para voltar as opções iniciais caso seja apagado o texto do textarea */
    function handleContentCanged(event: ChangeEvent<HTMLTextAreaElement>) {
              ...
              <div className='flex flex-1 flex-col gap-3 p-5'>
                ...
                {shouldShowOnBoarding ? (
                  ...
                  <textarea 
                    ...
                    onChange={handleContentCanged}
                  />
                )}
              </div>

              <button type='submit' className='w-full bg-lime-400 py-4 text-center text-sm text-lime-950 outiline-none font-medium hover:bg-lime-500'>
                Salvar nota
              </button>
            </form>
          </Dialog.Content>
